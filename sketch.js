...
function setup(){
  ...
  //criou vários corpos de partículas
    ...
    // rotator1 = retângulo(250,200,150,20,rotator_options);
...
function draw(){
  ...
  //forma criada para avião e suporte
  rect(plane.position.x,plane.position.y,1200,20);
  rect(block1.position.x,block1.position.y,150,20);
  rect(block2.position.x,block2.position.y,150,20);

  //criou forma para todas as partículas
 ...
 //criou forma para todos os rotadores
